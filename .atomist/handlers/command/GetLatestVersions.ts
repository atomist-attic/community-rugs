...
/**
 * A Displays the latest versions for rug and rugs.
 */
@CommandHandler("GetLatestVersions", "Displays the latest versions for rug and rugs")
@Tags("community", "rug")
@Intent("latest versions", "show versions", "show latest verions")
